...
<main class="protection-donnees">
	...
	<p>
		Vos données sont accessibles uniquement au personnel autorisé de SkillFusion et à nos sous-traitants 
		(hébergeur, service de paiement si applicable).
	</p>
	
	<h2>6. Durée de conservation</h2>
	<p>
		Les données sont conservées pendant la durée nécessaire à la fourniture des services, 
		plus 3 ans après la fermeture du compte pour des raisons légales.
	</p>
	
	<h2>7. Sécurité des données</h2>
	<p>
		Nous mettons en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données 
		contre la perte, l'altération ou l'accès non autorisé.
	</p>
