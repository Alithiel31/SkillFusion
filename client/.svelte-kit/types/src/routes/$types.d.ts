...
type LayoutRouteId = RouteId | "/" | "/accessibilite" | "/conditions" | "/connection" | "/contact" | "/cours" | "/cours/[slug]" | "/mentions-legales" | "/plan-du-site" | "/profil" | "/protection-donnees" | "/register" | "/tableau-de-bord/admin" | "/tableau-de-bord/instructor" | "/tableau-de-bord/student" | null
